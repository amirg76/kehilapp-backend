...
// The old admin account (admin@weunity.com / password123) is included so the
...
const users = [
  ...
  { name: 'מנהל (ותיק)', email: 'admin@weunity.com', role: 'admin', password: 'password123' },
];
...
const run = async () => {
  ...
  console.log(`\ndone. sign in with ${users[0].email} / ${DEMO_PASSWORD}  (or admin@weunity.com / password123)`);
};
